...
app.post("/download", (req, res) => {
  ...
  // Si se proporcionan cookies, agregarlas al comando
  const cookiesOption = cookies ? `--cookies "${cookies}"` : "";

  const cmd = `yt-dlp ${cookiesOption} -x --audio-format mp3 -o "${outputTemplate}" "${url}"`;
